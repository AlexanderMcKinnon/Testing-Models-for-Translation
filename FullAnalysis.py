...
def FullAnalysisRun(information):
    import numpy as np
    ...
    for i in range(len(information)):
        ...
        if info[2] == "3":
            mi3_labels = [["m_"+info[0], "m_"+info[2], "Exo", "Rib", "Lm"+info[2]+"_"+info[0], "Ym"+info[2]+"_"+info[0], "Nm_"+info[0], "Cm_"+info[0]], ["Cm_"+info[0], "m_"+info[2], "Exo", "Rib", "LC"+info[2]+"_"+info[0], "YC"+info[2]+"_"+info[0], "Nm_"+info[0], "m_"+info[0]]]
            #Iterate through all sub-species
            for k in range(len(mi3_labels)):
                ...
                out =  mRNA_3miRNAdegradation_fullpathway(*tuple(list(IN)+[k]))
                for j in range(len(mi3_labels[k])):
        ...
        if info[2] == "5":
            mi5_labels = ["m_"+info[0], "m_"+info[2], "Exo", "Rib", "Lm"+info[2]+"_"+info[0], "Ym"+info[2]+"_"+info[0], "Nm_"+info[0], "K_"+info[0], "Cm_"+info[0]]
            #Iterate through all sub-species
            temp_species_syms = []
            ...
            out =  mRNA_5miRNAdegradation_fullpathway(*tuple(list(IN)+[0]))
            for j in range(len(mi5_labels)):
    ...
    for i in range(len(experimental_data)):
        experimental_data_index = list(species_syms.keys()).index(list(experimental_data.keys())[i])
        experimental_data_indecies = experimental_data_indecies + [experimental_data_index]
        experimental_estimation_data = np.concatenate((experimental_estimation_data, list(experimental_data.values())[i]))
