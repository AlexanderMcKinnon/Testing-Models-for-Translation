...
def CreateReactionFunction(information):
    ...
    return {"Model": model, "Reaction_functions": reaction_function, "Initial_values": Initial_values,"Rates_values": Rates_values, "Rates_indexes":Rates_indexes, "Protien_indexes": [ list(species_syms.keys()).index("P_G"), list(species_syms.keys()).index("P_R")]}